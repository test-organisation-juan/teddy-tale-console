...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 z-40 w-64 gradient-sidebar border-r border-border/50 shadow-elegant
                ...
                <NavLink
                  ...
                  className={`
                    ...
                    ${isActive 
                      ...
                      : 'hover:bg-muted/80 text-foreground hover:scale-105 hover:shadow-card'
                    }
                  `}
                >
